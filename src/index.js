...
import { requestingHotels } from "./hotel.js";
...
data.forEach((hotel, index) => {
    if (index <= 18) {
        ...
        const imgFlagCreated = document.createElement("src");
...
const errorMessageElement = document.getElementById("error-message");
    ...
    errorMessageElement.textContent = "Search results for hotels were not found.Please enter new search statuses.";
